...
module chassis_y_equipe(largeur,longueur,hauteur_base,decal){
  ...
  copy_mirror([1,0,0]) color([0.2,0.2,0.2]) translate([-entraxe_y/2,0,hauteur_base-30/2+5]) rotate([90,0,0]) cylinder(d=8,h=longueur-30*2, center=true);
...
translate([0,-longueur/2+30,hauteur_base-30/2]) rotate([180,180,180]) y_motor();
  ...
  // Tendeur Y
  translate([-30,longueur/2-30,hauteur_base-30/2]) rotate([-90,0,180]) y_belt_idler_1();
  translate([-30,longueur/2-30,hauteur_base-30/2]) rotate([-90,0,180]) y_belt_idler_2();
